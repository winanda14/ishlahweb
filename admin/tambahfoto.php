...
<div class="col-md-10  d-inline-block" style="background-color:#C9D8CE; height:600px; overflow:auto;">
<h3 class="pt-2 ml-3 "></h3>
<tr>
  <td >JUDUL </td><td>:</td><td><input type="text" name="input">
</tr>
<br><br>

<div class="custom-file col-sm-10 col-md-3">
  <input type="file" class="custom-file-input" id="customFile">
  <label class="custom-file-label" for="customFile" style="margin-left: 50px; margin-right: 50px;">Pilih File</label>
</div>
